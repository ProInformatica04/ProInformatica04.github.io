...
preload() {
        ...
        this.load.audio('musicaPurgatorio', './assets/MusicaParadiso.mp3');
    }
create() {
        const BottoniNomi = [
        { name: 'Livello 1', },
        ...
        var text = this.add.text(70, 100, '', { font: '20px Courier Bold', fill: '#00ff00' });
