...
create() {
        ...
        Bottone1.on('pointerdown', function (pointer) {
            ...
            this.cameras.main.on('camerafadeoutcomplete', function(camera, effect) {
                    ...
                    this.scene.start('ScenaProva',{ level : this.data.get('level'), lives : this.data.get('lives'), score : this.data.get('score'), playername : this.data.get('playername') });   
                }, this);
        }, this);
